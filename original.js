//** StarWars like Twitter Timeline Javascript
// by @yanoshin
(function () {
    var tweets = document.getElementById('stream-items-id');
    ...
    tag_html.appendChild(new_body);

    var tag_article = document.createElement('article');
    tag_article.className = 'starwars';

    var div_animation = document.createElement('div');
    div_animation.className = 'animation';

    var tag_section = document.createElement('section');
    tag_section.className = 'intro';
    var intro_text = document.createTextNode('A long time ago, in a galaxy');
    tag_section.appendChild(intro_text);
    intro_text = document.createElement('br');
    tag_section.appendChild(intro_text);
    intro_text = document.createTextNode('far,far away....');
    tag_section.appendChild(intro_text);
    div_animation.appendChild(tag_section);

    var section_titles = document.createElement('section');
    section_titles.className = 'titles';

    var div_title_holder = document.createElement('div');
    div_title_holder.setAttribute('contenteditable', 'true');
    div_title_holder.setAttribute('spellcheck', 'false');

    div_title_holder.appendChild(tweets);

    section_titles.appendChild(div_title_holder);

    div_animation.appendChild(section_titles);

    var section_logo = document.createElement('section');
    section_logo.className = 'logo';
