(function () {
    ...
    var ar = ce('article');
    ar.className = 'starwars';

    var an = ce('div');
    an.className = 'animation';

    var se = ce('section');
    se.className = 'intro';
    var it = document.createTextNode('A long time ago, in a galaxy');
    ap(se, it);
    it = ce('br');
    ap(se, it);
    it = document.createTextNode('far,far away....');
    ap(se, it);
    ap(an, se);
    ...
    var th = ce('div');
    sa(th, 'contenteditable', 'true');
    sa(th, 'spellcheck', 'false');
    ...
    sa(tif, 'width', '0');
    sa(tif, 'height', '0');
    sa(tif, 'src', 'https://www.youtube.com/embed/tGsKzZtRwxw?loop=1&autoplay=0');
    sa(tif, 'style', 'display:none');
    ap(bd, tif);

    function startBGM() {
        sa(tif, 'src', 'https://www.youtube.com/embed/tGsKzZtRwxw?loop=1&autoplay=1');
    }
